...
const firstHoliday = `${firstDay}/${firstMonth}/${currentYear}`;
const lastHoliday = `${lastDay}/${lastMonth}/${currentYear}`;

console.log(firstHoliday);
console.log(lastHoliday);

const random = Math.floor(Math.random() * (0,1,2,3,4,5,6,7,8))
const randomHoliday = holidays[random].date.toLocaleDateString('en-GB')
